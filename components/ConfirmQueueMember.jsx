    ...
    <div className="flex items-center">
     {isInput && (
      <input
       ...
       className="w-1/2 m-3 bg-white border-2 h-8 md:h-9 border-solid border-amber-400 rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-600 focus:border-transparent"
       value={inputValue}
