...
export const ConfirmBox = ({ queueName }) => {
 return (
  <div className="flex flex-col items-center justify-center md:h-[50vh] md:w-[50vw] h-[30vh] w-[70vh] border-[6px] border-purple-800 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-slate-50 drop-shadow-2xl">
